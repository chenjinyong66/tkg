...
from src.lightrag.api.utils_api import display_splash_screen, check_env_file
from src.lightrag.api.config import global_args
...
def main():
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from src.lightrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from src.lightrag.api.lightrag_server import get_application
