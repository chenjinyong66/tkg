...
from src.lightrag.api.utils_api import (
...
from src.lightrag.utils import get_env_value
from lightrag import LightRAG, __version__ as core_version
from src.lightrag.api import __api_version__
from src.lightrag.types import GPTKeywordExtractionFormat
from src.lightrag.utils import EmbeddingFunc
from src.lightrag.constants import (
...
from src.lightrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from src.lightrag.api.routers.query_routes import create_query_routes
from src.lightrag.api.routers.graph_routes import create_graph_routes
from src.lightrag.api.routers.ollama_api import OllamaAPI

from src.lightrag.utils import logger, set_verbose_debug
from src.lightrag.kg.shared_storage import (
    get_namespace_data,
...
from src.lightrag.api.auth import auth_handler
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from src.lightrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from src.lightrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from src.lightrag.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from src.lightrag.llm.binding_options import OllamaEmbeddingOptions
...
def create_app(args):
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from src.lightrag.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from src.lightrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(config_cache: LLMConfigCache, args):
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from src.lightrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from src.lightrag.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from src.lightrag.llm.ollama import ollama_model_complete
    ...
    def create_optimized_embedding_function(
        ...
        async def optimized_embedding_function(texts):
            try:
                if binding == "lollms":
                    from src.lightrag.llm.lollms import lollms_embed
                    ...
                    from src.lightrag.llm.azure_openai import azure_openai_embed

                    return await azure_openai_embed(texts, model=model, api_key=api_key)
                elif binding == "aws_bedrock":
                    from src.lightrag.llm.bedrock import bedrock_embed

                    return await bedrock_embed(texts, model=model)
                elif binding == "jina":
                    from src.lightrag.llm.jina import jina_embed

                    return await jina_embed(
                        texts, dimensions=dimensions, base_url=host, api_key=api_key
                    )
                else:  # openai and compatible
                    from src.lightrag.llm.openai import openai_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from src.lightrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from src.lightrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from src.lightrag.api.config import OllamaServerInfos
