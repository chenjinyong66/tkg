...
from src.lightrag.base import StoragesStatus
...
async def check_lightrag_setup(rag_instance: LightRAG, verbose: bool = False) -> bool:
    ...
    if issues:
        ...
        print("  from src.lightrag.kg.shared_storage import initialize_pipeline_status")
...
async def demo():
    ...
    from src.lightrag.llm.openai import openai_embed, gpt_4o_mini_complete
