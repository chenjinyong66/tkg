...
from src.graph_core.cross_encoder.client import CrossEncoderClient
from src.graph_core.cross_encoder.openai_reranker_client import OpenAIRerankerClient
from src.graph_core.decorators import handle_multiple_group_ids
from src.graph_core.driver.driver import GraphDriver
from src.graph_core.driver.neo4j_driver import Neo4jDriver
from src.graph_core.edges import (
    CommunityEdge,
    Edge,
    EntityEdge,
    EpisodicEdge,
...
from src.graph_core.embedder import EmbedderClient, OpenAIEmbedder
from src.graph_core.errors import NodeNotFoundError
from src.graph_core.graphiti_types import GraphitiClients
from src.graph_core.helpers import (
    get_default_group_id,
    semaphore_gather,
    validate_excluded_entity_types,
    validate_group_id,
)
from src.graph_core.llm_client import LLMClient, OpenAIClient
from src.graph_core.nodes import (
    CommunityNode,
    EntityNode,
    EpisodeType,
    EpisodicNode,
...
from src.graph_core.search.search import SearchConfig, search
from src.graph_core.search.search_config import DEFAULT_SEARCH_LIMIT, SearchResults
from src.graph_core.search.search_config_recipes import (
    COMBINED_HYBRID_SEARCH_CROSS_ENCODER,
    EDGE_HYBRID_SEARCH_NODE_DISTANCE,
    EDGE_HYBRID_SEARCH_RRF,
)
from src.graph_core.search.search_filters import SearchFilters
from src.graph_core.search.search_utils import (
    RELEVANT_SCHEMA_LIMIT,
    get_mentioned_nodes,
)
from src.graph_core.telemetry import capture_event
from src.graph_core.tracer import Tracer, create_tracer
from src.graph_core.utils.bulk_utils import (
    RawEpisode,
...
from src.graph_core.utils.datetime_utils import utc_now
from src.graph_core.utils.maintenance.community_operations import (
    build_communities,
    remove_communities,
    update_community,
)
from src.graph_core.utils.maintenance.edge_operations import (
    build_episodic_edges,
    extract_edges,
    resolve_extracted_edge,
    resolve_extracted_edges,
)
from src.graph_core.utils.maintenance.graph_data_operations import (
    EPISODE_WINDOW_LEN,
    retrieve_episodes,
)
from src.graph_core.utils.maintenance.node_operations import (
    extract_attributes_from_nodes,
    extract_nodes,
    resolve_extracted_nodes,
)
from src.graph_core.utils.ontology_utils.entity_types_utils import validate_entity_types
...
class Graphiti:
    def __init__(
        ...
        trace_span_prefix: str = 'graph_core',
    ):
        """
        ...
        trace_span_prefix : str, optional
            Prefix to prepend to all span names. Defaults to 'graph_core'.
    ...
    async def close(self):
        ...
        Example:
            graph_core = Graphiti(uri, user, password)
            try:
                # Use graph_core...
            finally:
                graph_core.close()
    ...
    async def retrieve_episodes(
        ...
        from the `graph_core.utils` module.
        """
        if driver is None:
    ...
    async def add_episode(
        ...
        Example using FastAPI background tasks:
            ...
            async def add_episode_endpoint(episode_data: EpisodeData):
                background_tasks.add_task(graph_core.add_episode, **episode_data.dict())
    ...
    async def search(
        ...
        search method graph_core.search_().
