...
from src.graph_core.helpers import semaphore_gather
from src.graph_core.llm_client import LLMClient
from src.graph_core.llm_client.config import ModelSize
...
from src.graph_core.prompts import prompt_library
from src.graph_core.prompts.dedupe_nodes import NodeDuplicate, NodeResolutions
from src.graph_core.prompts.extract_nodes import (
    EntitySummary,
    ExtractedEntities,
    ExtractedEntity,
    MissedEntities,
)
from src.graph_core.search.search import search
from src.graph_core.search.search_config import SearchResults
from src.graph_core.search.search_config_recipes import NODE_HYBRID_SEARCH_RRF
from src.graph_core.search.search_filters import SearchFilters
from src.graph_core.utils.datetime_utils import utc_now
from src.graph_core.utils.maintenance.dedup_helpers import (
...
from src.graph_core.utils.text_utils import MAX_SUMMARY_CHARS, truncate_at_sentence
...
async def extract_nodes(
    ...
    # 打印原始 LLM 响应用于调试
    print(f"测试DEBUG: Raw LLM response: {llm_response}")
    ...
    try:
        ...
        print(f"ERROR: Raw response was: {llm_response}")
