...
if TYPE_CHECKING:
    ...
    try:
        ...
        raise ImportError(
            ...
            'Install it with: pip install graph_core-core[falkordb]'
        ) from None

from src.graph_core.driver.driver import GraphDriver, GraphDriverSession, GraphProvider
from src.graph_core.graph_queries import get_fulltext_indices, get_range_indices
