...
class OpenTelemetryTracer(Tracer):
    ...
    def __init__(self, tracer: Any, span_prefix: str = 'graph_core'):
        """
...
def create_tracer(otel_tracer: Any | None = None, span_prefix: str = 'graph_core') -> Tracer:
    """
    ...
    >>> tracer = create_tracer(otel_tracer, span_prefix='myapp.graph_core')
